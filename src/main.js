...
//             <div class="imgPoke" id="imgPoke"><img src=${element.img}
//                  alt="" class="imgPkm"></div>
//             <div class="namePoke" id="namePoke">${element.name.toUpperCase()}</div>
//             </section>

//             <section id="pokeCard2" class="pokeCard">
//             <div class="number" id="number">${element.num}</div>
//             <div class="maxCP" id="maxCP">
//                <span class="cp">Max-CP: ${element.stats['max-cp']}</span></div>
//             </section>
//        `;
//     showData += pokeDat;
//   });
//
// };
const showData = dataCards(data.pokemon);
